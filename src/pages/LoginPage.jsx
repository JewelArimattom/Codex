...
import { Mail, Lock, PenLine, ArrowRight } from 'lucide-react'
...
const LoginPage = () => {
  ...
  useEffect(() => {
    const storedCredentials = localStorage.getItem('codex_credentials')
    if (storedCredentials) {
      try {
        ...
        // Check if credentials are still valid (within 2 days)
    ...
    <div className="min-h-screen flex items-center justify-center px-6 py-12">
      ...
      >
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-secondary">Sign in to continue your writing journey</p>
        </div>
        ...
        <p className="mt-8 text-center text-xs text-secondary">
          By continuing, you agree to Codex's{' '}
