...
import { Mail, Lock, User, PenLine, ArrowRight, CheckCircle2 } from 'lucide-react'
...
const SignupPage = () => {
  ...
  const handleSubmit = (e) => {
    ...
    localStorage.setItem('codex_credentials', JSON.stringify(credentialsData))
    ...
    localStorage.setItem('codex_auth', JSON.stringify(authData))
      ...
      >
        ...
        <div className="text-center mb-10">
          <Link to="/" className="inline-flex items-center space-x-2 group mb-8">
            ...
            <span className="text-2xl font-bold text-primary">Codex</span>
          </Link>
          <h1 className="text-3xl font-bold text-primary mb-2">Start your journey</h1>
          <p className="text-secondary">Create an account to share your stories with the world</p>
        </div>
        ...
        >
              ...
              {formData.password && (
                <div className="mt-2">
                  <div className="flex items-center justify-between mb-1">
                    ...
                    <span className={`text-xs font-medium ${passwordStrength >= 3 ? 'text-green-600' : 'text-secondary'}`}>
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-surface text-secondary">or sign up with</span>
            </div>
          </div>

          {/* Social Signup Buttons */}
          <div className="grid grid-cols-2 gap-3">
            <button className="btn-secondary text-sm flex items-center justify-center space-x-2">
